...
interface Promise<T> extends PromiseLike<T>, Promise.Inspection<T> {
    ...
    * });
     ...
     *
     * Its fulfillment value is an object that implements the PromiseInspection interface and reflects the resolution of this promise.
     */
    reflect<U>(): Promise.Inspection<U>;
